              ...
              children: [
                ...
                Padding(
                 ...
                 Row(children: [
                  ...
                  Spacer(),
                  Checkbox(value: isAdoptChecked, onChanged: (Value)=>setState(() {
                ...
                Text("Price Range"),SizedBox(height: 5,),
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: TextField(decoration: InputDecoration(labelText: "Location",border: OutlineInputBorder()),),
                ),
                Row(children: [
                  Padding(
                  ...
                  Spacer(),
                  Checkbox(value: isVaccinatedChecked, onChanged: (value)=>setState(() {
                ...
                Row(children: [
                  ...
                  Spacer(),
                  Checkbox(value: isCertifiedChecked, onChanged: (value)=>setState(() {
                ...
                ElevatedButton(onPressed: (){}, style: ElevatedButton.styleFrom(minimumSize: Size(300, 50),backgroundColor: Colors.orange),child: Text("Apply",style: TextStyle(fontSize: 20,color: Colors.white),),
                )
              ],
            ),
          ],
